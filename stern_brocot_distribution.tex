...
2^{n+3}-9  & \in N'^{4n-1} \forall n \in \mathbb{N}_{1} \\
2^{n+3}-11 & \in N'^{5n-2} \forall n \in \mathbb{N}_{1} \\
2^{n+3}-13 & \in N'^{5n-3} \forall n \in \mathbb{N}_{1} \\
2^{n+3}-15 & \in N'^{4n-3} \forall n \in \mathbb{N}_{1}
\end{aligned}\end{displaymath}
...
2^{n+2}+9  & \in N'^{4n-1} \forall n>1 \in \mathbb{N}_{1} \\
2^{n+2}+11 & \in N'^{5n-2} \forall n>1 \in \mathbb{N}_{1} \\
2^{n+2}+13 & \in N'^{5n-3} \forall n>1 \in \mathbb{N}_{1} \\
2^{n+2}+15 & \in N'^{4n-3} \forall n>1 \in \mathbb{N}_{1}
\end{aligned}\end{displaymath}
